...
maria = Usuario("María", "Camacho", 32, "Chile", "Mujer")
antonio = Usuario("Antonio", "Rossi", 17, "Francía", "Hombre")
evelyn = Usuario("Evelyn", "Jones", 24, "Canadá", "No binario")

usuarios = [maria, antonio, evelyn]
