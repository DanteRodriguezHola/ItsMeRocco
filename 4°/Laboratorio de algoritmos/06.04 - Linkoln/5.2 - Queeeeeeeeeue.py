class Queue:
    def __init__(self):
        self.queue = EnlazadaSimple()

    def enqueue(self, nuevo_valor):
        self.queue.agregar_nodo(nuevo_valor)
    ...
    def dequeue(self):
        if self.isEmpty():
            ...
            primer_valor = self.queue.cabeza.data
            self.queue.cabeza = self.queue.cabeza.siguiente
            return primer_valor
    ...
    def isEmpty(self):
        return self.queue.esta_vacia()

    def size(self):
        return self.queue.tamano()
